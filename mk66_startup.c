...
void Software_IRQHandler(void) 			__attribute__((weak, alias("Default Handler")));
...
uint32_t vectors[]	__attribute__((section(".isr_vectors"))) = {
	...
	0,
	(uint32_t)&UART0_Status_IRQHandler,
	(uint32_t)&UART0_ERR_IRQHandelr,
	(uint32_t)&UART1_Status_IRQHandler,
	(uint32_t)&UART1_ERR_IRQHandler,
	(uint32_t)&UART2_Status_IRQHandler,
	(uint32_t)&UART2_ERR_IRQHandler,
	(uint32_t)&UART3_Status_IRQHandler,
	...
	(uint32_t)&PDB_IRQHandler,
	(uint32_t)&USBFS_OTG_IRQHandler,
	(uint32_t)&USBFS_CHRG_DTCT_IRQHandler,
	0,
	(uint32_t)&DAC0_IRQHandler,
	(uint32_t)&MCG_IRQHandler,
	(uint32_t)&LPTMR_IRQHandler,
	(uint32_t)&PORTA_PIN_DTCT_IRQHandler,
	(uint32_t)&PORTB_PIN_DTCT_IRQHandler,
	(uint32_t)&PORTC_PIN_DTCT_IRQHandler,
	(uint32_t)&PORTD_PIN_DTCT_IRQHandler,
	(uint32_t)&PORTE_PIN_DTCT_IRQHandler,
	(uint32_t)&Software_IRQHandler,
	(uint32_t)&SPI2_IRQHandler,
	(uint32_t)&UART4_Status_IRQHandler,
	...
	(uint32_t)&CAN0_ORMsgBuf_IRQHandler,
	(uint32_t)&CAN0_BusOff_IRQHandler,
	(uint32_t)&CAN0_ERR_IRQHandler,
	(uint32_t)&CAN0_TX_WRNG_IRQHandler,
	(uint32_t)&CAN0_RX_WRNG_IRQHandler,
	(uint32_t)&CAN0_WakeUp_IRQHandler,
	(uint32_t)&SDHC_IRQHandler,
	(uint32_t)&ETHMAC_TMRInt_IRQHandler,
	(uint32_t)&ETHMAC_TX_IRQHandler,
	(uint32_t)&ETHMAC_RX_IRQHandler,
	(uint32_t)&ETHMAC_ERR_IRQHandler,
	(uint32_t)&LPUART0_Stat_ERR_IRQHandler,
	(uint32_t)&TSI0_IRQHandler,
	(uint32_t)&TPM1_IRQHandler,
	(uint32_t)&TPM2_IRQHandler,
	(uint32_t)&USBHS_DCD_Phy_IRQHandler,
	(uint32_t)&I2C3_IRQHandler,
	(uint32_t)&CMP3_IRQHandler,
	(uint32_t)&USBHS_OTG_IRQHandler,
	(uint32_t)&CAN1_ORMsgBuf_IRQHandler,
	(uint32_t)&CAN1_BusOff_IRQHandler,
	(uint32_t)&CAN1_ERR_IRQHandler,
	(uint32_t)&CAN1_TX_WRNG_IRQHandler,
	(uint32_t)&CAN1_RX_WRNG_IRQHandler,
	(uint32_t)&CAN1_WakeUp_IRQHandler
};
